...
import 'features/home/domain/use_cases/categories_tab_use_case.dart' as _i16;
...
import 'features/products/domain/use_cases/add_to_cart_use_case.dart' as _i17;
import 'features/products/domain/use_cases/all_products_use_case.dart' as _i18;
import 'features/products/domain/use_cases/get_cart_use_case.dart' as _i19;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i16.CategoriesTabUseCase>(
        () => _i16.CategoriesTabUseCase(homeRepo: gh<_i8.HomeRepo>()));
    gh.factory<_i17.AddProductToCartUseCase>(
        () => _i17.AddProductToCartUseCase(gh<_i10.AllProductsRepo>()));
    gh.factory<_i18.AllProductsUseCase>(
        () => _i18.AllProductsUseCase(gh<_i10.AllProductsRepo>()));
    gh.factory<_i19.GetProductToCartUseCase>(
        () => _i19.GetProductToCartUseCase(gh<_i10.AllProductsRepo>()));
    gh.factory<_i20.RemoveProductFromCartUseCase>(
        () => _i20.RemoveProductFromCartUseCase(gh<_i10.AllProductsRepo>()));
    gh.factory<_i21.HomeBloc>(() => _i21.HomeBloc(
          ...
          categoriesTabUseCase: gh<_i16.CategoriesTabUseCase>(),
    ...
    gh.factory<_i22.ProductsBloc>(() => _i22.ProductsBloc(
          gh<_i18.AllProductsUseCase>(),
          gh<_i17.AddProductToCartUseCase>(),
          gh<_i19.GetProductToCartUseCase>(),
          gh<_i20.RemoveProductFromCartUseCase>(),
        ));
    return this;
  }
}
