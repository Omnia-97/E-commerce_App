...
import 'features/home/domain/use_cases/categories_tab_use_case.dart' as _i17;
...
import 'features/home/domain/use_cases/get_product_to_wish_list_use_case.dart'
    as _i15;
import 'features/home/domain/use_cases/remove_product_from_wish_use_case.dart'
    as _i16;
...
import 'features/products/domain/use_cases/add_to_cart_use_case.dart' as _i19;
import 'features/products/domain/use_cases/all_products_use_case.dart' as _i20;
import 'features/products/domain/use_cases/get_cart_use_case.dart' as _i21;
import 'features/products/domain/use_cases/remove_product_from_cart.dart'
    as _i22;
import 'features/products/presentation/bloc/products_bloc.dart' as _i23;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i15.GetProductToWishListUseCase>(
        () => _i15.GetProductToWishListUseCase(gh<_i8.HomeRepo>()));
    gh.factory<_i16.RemoveProductFromWishUseCase>(
        () => _i16.RemoveProductFromWishUseCase(gh<_i8.HomeRepo>()));
    gh.factory<_i17.CategoriesTabUseCase>(
        () => _i17.CategoriesTabUseCase(homeRepo: gh<_i8.HomeRepo>()));
    gh.factory<_i18.HomeBloc>(() => _i18.HomeBloc(
          ...
          categoriesTabUseCase: gh<_i17.CategoriesTabUseCase>(),
          addProductToWishListUseCase: gh<_i12.AddProductToWishListUseCase>(),
          getProductToWishListUseCase: gh<_i15.GetProductToWishListUseCase>(),
          removeProductFromWishUseCase: gh<_i16.RemoveProductFromWishUseCase>(),
        ));
    gh.factory<_i19.AddProductToCartUseCase>(
        () => _i19.AddProductToCartUseCase(gh<_i10.AllProductsRepo>()));
    gh.factory<_i20.AllProductsUseCase>(
        () => _i20.AllProductsUseCase(gh<_i10.AllProductsRepo>()));
    gh.factory<_i21.GetProductToCartUseCase>(
        () => _i21.GetProductToCartUseCase(gh<_i10.AllProductsRepo>()));
    gh.factory<_i22.RemoveProductFromCartUseCase>(
        () => _i22.RemoveProductFromCartUseCase(gh<_i10.AllProductsRepo>()));
    gh.factory<_i23.ProductsBloc>(() => _i23.ProductsBloc(
          gh<_i20.AllProductsUseCase>(),
          gh<_i19.AddProductToCartUseCase>(),
          gh<_i21.GetProductToCartUseCase>(),
          gh<_i22.RemoveProductFromCartUseCase>(),
        ));
    return this;
  }
}
